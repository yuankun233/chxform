    ...
    <view class="box">
        ...
        <view class="index_1">
            ...
            <view class="form111">
                ...
                <view class="index_1_text_3">
                    <view>身份证号码:</view>
                    <view><input type="text" placeholder="请输入" v-model="form1.idcard" /></view>
                </view>
                ...
                <view class="index_1_text_3">
                    <view>联系电话:</view>
                    <view><input type="text" placeholder="请输入" v-model="form1.tel" /></view>
                </view>
                <view class="index_1_text_2">
        ...
        <view class="index_2">
            ...
            <view>
                ...
                <view class="index_1_text_3">
                    <view>联系电话:</view>
                    <view><input type="text" placeholder="请输入" v-model="form2.tel" /></view>
                </view>
                <view class="index_1_text_3">
                    <view>身份证号码:</view>
                    <view><input type="text" placeholder="请输入" v-model="form2.idcard" /></view>
                </view>
                <view class="index_1_text_3">
                    <view>联系地址:</view>
